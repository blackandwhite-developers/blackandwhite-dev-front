...
const Cartview = (props: CartviewProps) => {
  ...
  return (
    <div className={cx("cart-container")}>
      <Header title={"객실상세"} leftIcon={<FaAngleLeft onClick={handleGoBack} />} rightIcon={<RiHome6Line onClick={handleGoHome} />} />
              ...
              <div className={cx("info-product")}>
                ...
                <div className={cx("bottom-info")}>
                  ...
                  <div className={cx("rest-info")}>
                    ...
                    <p className={cx("price")}>{item.price.toLocaleString()}원</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className={cx("bottom-container")}>
        ...
        <div className={cx("payment-info")}>
          ...
          <div className={cx("amount-price")}>
            <span>결제 예상 금액</span>
            <span>{resultPrice.toLocaleString()}원</span>
          </div>
        </div>
        ...
        <div className={cx("bottom-sheet")}>
          <div className={cx("amount-count")}>
            ...
            <div className={cx("cash")}>
              ...
              <span className={cx("cash-total")}>{resultPrice.toLocaleString()}원</span>
            </div>
          </div>
          <AbleBtn label="예약하기" />
        </div>
