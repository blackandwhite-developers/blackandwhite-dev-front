...
const Birth = (props: BirthProps) => {
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>, type: "year" | "month" | "day") => {
    ...
    <div className={cx("SelectBirthWrapper")}>
      ...
      <form>
        <div className={cx("InputWrapper")}>
          <input type="text" id="year" name="year" ref={year} placeholder="1990" className={cx("BirthInput")} required maxLength={4} onChange={(e) => handleInputChange(e, "year")} />
          /
          <input type="text" id="month" name="month" ref={month} placeholder="01" className={cx("BirthInput")} required maxLength={2} onChange={(e) => handleInputChange(e, "month")} />
          /
          <input type="text" id="day" name="day" ref={day} placeholder="01" className={cx("BirthInput")} required maxLength={2} onChange={(e) => handleInputChange(e, "day")} />
        </div>
      </form>
